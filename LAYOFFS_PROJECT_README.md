...
- **Techniques**: Self-joins, Aggregations, Partitioning

---

## 💡 How to Use

1. Load your layoffs dataset into MySQL
2. Run **Project data cleaning.sql** to clean and standardize the data
3. Run **Exploratory Data Analysis.sql** to generate insights
4. Modify queries to answer specific business questions

---

## 📈 Sample Queries

**Find top 5 companies by layoffs per year:**
```sql
with company_cte as
...
**View rolling total of layoffs by month:**
```sql
with cte_example as 
...
- Using window functions for ranking and rolling calculations
- Self-joins for data enrichment and filling missing values
- Aggregations and grouping for discovering patterns
